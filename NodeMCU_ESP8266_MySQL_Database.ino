...
const char* ssid = "sohit";                  // Your wifi Name       
const char* password = "cobabuka";          // Your wifi Password

const char *host = "192.168.43.37"; //Your pc or server (database) IP, example : 192.168.0.0 , if you are a windows os user, open cmd, then type ipconfig then look at IPv4 Address.
...
void loop() {
 ...
 // put your main code here, to run repeatedly:
  ...
  http.begin("http://192.168.43.37:8080/Nodemcu_db_record_view/InsertDB.php");              //Specify request destination
  ...
  Serial.println("ldrvalue==" + LdrValueSend);
